...
#'   \item{signature}{a character string containing the bake for the signature challenge for that baker/episode. If `NA`, baker did not appear in episode.}
#'   \item{technical}{an integer denoting the rank on the technical challenge for that baker/episode; rank = 1 is winner of the technical challenge. If `NA`, baker did not appear in episode.}
#'   \item{showstopper}{a character string containing the bake for the showstopper challenge for that baker/episode. If `NA`, baker did not appear in episode.}
#' }
